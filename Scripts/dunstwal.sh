...
sed -i "s/foreground = .*/foreground = \"$kolor15\"/g" ~/.config/dunst/dunstrc
sed -i "s/frame_color = .*/frame_color = \"$kolor01\"/g" ~/.config/dunst/dunstrc

pkill dunst
dunst &
notify-send "New Colour Scheme" "test" -u normal